...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    sourceKind: "github",
    description:
      "Daily workplace English practice for non-native engineers\u2014risk, decisions, ownership, and next-step language, not just grammar.",
    category: "Learning AI",
    canDo: "Generate realistic engineering scenarios, review line-by-line, and save reusable senior-engineer phrases.",
    bestFor: "Engineers who need clearer workplace English for PRs, incidents, and stakeholder updates.",
    ...
    screenshots: [
      {
        ...
        alt: "XingAI Engineering English Coach",
        caption: "Daily practice and line-by-line review",
      },
    ],
    features: [
      { name: "Daily workplace scenarios", free: true, pro: true, enterprise: true },
      { name: "Line-by-line review", free: true, pro: true, enterprise: true },
    ...
    roadmap: [
      { title: "Mobile chrome + en/zh/ko", status: "shipped" },
      { title: "Deterministic scenario + review engine", status: "shipped" },
...
> = {
  zh: {
    ...
    "engineering-coach": {
      ...
      category: "学习 AI",
      description:
        "面向非母语工程师的职场英语每日练习——风险、决策、责任与下一步，而不只是语法。",
      canDo: "生成真实工程场景，逐句评审，并沉淀可复用的资深工程师表达。",
      bestFor: "需要更清楚地写 PR、事故同步与干系人更新的工程师。",
      clickTarget: "产品详情与 GitHub 源码。",
      screenshots: ["每日练习与逐句评审"],
      features: [
        "每日职场场景",
        "逐句评审",
        "可复用资深表达",
  ...
  ko: {
    ...
    "engineering-coach": {
      ...
      category: "학습 AI",
      description:
        "비원어민 엔지니어를 위한 직장 영어 일일 연습 — 문법만이 아니라 리스크·결정·책임·다음 단계 언어.",
      canDo: "현실적인 엔지니어링 시나리오를 만들고 문장별 리뷰와 재사용 표현을 제공합니다.",
      bestFor: "PR·장애·이해관계자 업데이트를 더 명확히 써야 하는 엔지니어.",
      clickTarget: "제품 상세와 GitHub 소스.",
      screenshots: ["일일 연습과 문장별 리뷰"],
      features: [
        "일일 직장 시나리오",
        "문장별 리뷰",
        "재사용 시니어 표현",
