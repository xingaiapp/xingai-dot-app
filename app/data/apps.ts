...
export const apps: AppData[] = [
  ...
  },
  {
    ...
    launchStatus: "live",
    demoUrl: "https://passive.xingai.app/",
    comingSoon: false,
    screenshots: [
      {
    ...
    roadmap: [
      ...
      { title: "Today Idea UI + live JSON feed", status: "shipped" },
      { title: "Report worker PDF + Resend + web probe", status: "shipped" },
      { title: "passive.xingai.app deploy", status: "shipped" },
      { title: "Scheduled live email + archive depth", status: "planned" },
    ],
  },
  {
    slug: "founder-ai",
  ...
  zh: {
    "passive-income": {
      ...
      roadmap: [
        ...
        "今日 Idea UI + 实时 JSON",
        "报告 worker PDF + Resend + web probe",
  ...
  ko: {
    "passive-income": {
      ...
      roadmap: [
        ...
        "Today Idea UI + 라이브 JSON",
        "리포트 worker PDF + Resend + web probe",
